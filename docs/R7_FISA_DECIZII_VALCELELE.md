...
|---|---|---|---|
| 1 | Decizii nominale: cele 10 puncte aprobate cu variante și condiții; configurația participării confirmată separat | **26.09.2026, Razvan (în chat): APROBATE variantele recomandate pentru deciziile 1–5, 7, 8, 9 și 11** (lista „Decizii cerute lui Razvan” de mai jos). **Deschise:** 6 (plafonul de lichiditate — neîntrebat încă), 10 (configurația participării — „nu acum”), 12 (#63/#64 + cine verifică cele 35 de clauze — „nimic acum”; corecturile de date cl. 43 / textul garanției / Formular 3 / registrul celor 5 piese NU se aplică încă). Sumele (rezerva de penalități, dec. 3) le fixează Razvan. Aprobarea deciziilor NU reaprobă clauzele. Stare anterioară: **0 / 10 aprobate**. Configurația: id 14–17 `aplicabil=false` în registru, neconfirmată de Razvan; toate 12 formularele `de_pregatit` | aprobarea listei finale (rândurile 1–12), cu tipul fiecărei decizii |
...
> **26.09.2026 — răspunsul lui Razvan:** 1, 2, 3, 4, 5, 7, 8, 9, 11 = **aprobate ca recomandat**; 10 = „nu acum”; 12 (clauze + corecturi de date) = „nimic acum”; 6 = deschis. R7 rămâne DESCHIS pe 6, 10, 12 și pe verificarea celor 35 de clauze (criteriile 2–5).
