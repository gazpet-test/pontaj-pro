...
>
> **Actualizare runda 3 (25.09, noapte) — vezi `docs/R4_REZERVARE_ZONE_SI_COADA_NAS.md`:** costul dublu între taburi e
> închis în cod FĂRĂ schemă nouă — rezervare per (document, zonă, tăiere) în `analiza.rezervari_zone`, prin CAS, înainte
> de apelul AI (al doilea tab primește 409 „în lucru în alt tab”, zero AI; rezervarea expiră în 7 min și se poate prelua).
