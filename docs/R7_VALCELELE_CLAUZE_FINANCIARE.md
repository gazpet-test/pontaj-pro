...
| Etapa 2 (clauză suspensivă) | 29.067.716,7 lei (text) | 479 poz. 4296: „TOTAL EXECUȚIE \| 29.067.716,7” — **NECORELARE**: 8.298.909,16 + 29.067.716,70 = 37.366.625,86 ≠ 37.366.625,89 (vezi Verdict) |
...
- **Interpretare**: plafon pentru penalitățile executantului **neidentificat în sursele verificate** (479, 480); asimetrie (achizitorul plătește abia după 30+60 zile, plafonat).
...
- **Citat**: 479 III.1.6.a (pag. 11): „în cuantum de 370 000 lei […] contul RO71TREZ2015006XXX000189 [date beneficiar/cont de verificat], deschis la Trezoreria Călărași, beneficiar UAT Vâlcelele, CUI 379683.”
...
- **Rămâne deschis**: CUI 379683 (III.1.6.a, poz. ~50 500) vs 3796837 (I.1, poz. 289) — discrepanță CONFIRMATĂ în text și date beneficiar/cont de verificat (textul conține „XXX”) → verificare SEAP înainte de virament. Decizie: Razvan (virament vs polița de la broker). `ofertare_garantii` nu are rânduri pentru 95 (SELECT count(*) WHERE licitatie_id=95 → 0).
...
- **Interpretare**: **avans neconfirmat** — av=0 e doar termen al formulei; nu există clauză explicită de avans (vezi Verdict). Organizarea de șantier (100.000 + 34.446 lei, E1) se prefinanțează.
...
6. Valoarea exactă a E2: textul dă 29.067.716,7; suma cu E1 lasă 3 bani lipsă față de 37.366.625,89 — de cerut/verificat pe PDF.

## Verdict Copilot 25.09
**Avans.** SELECT pe `text_extras`: în 479 „avans” apare o singură dată (poz. 13658), în 480 de două ori (11527 = formula; 64861 = „pe masura ce lucrarile avanseaza”). Singurul text: „„av" este un coeficient fix și reprezintă valoarea procentuală a plății în avans față de Prețul Contractului; pentru prezentul contract av = 0”. **Nu există clauză explicită „nu se acordă avans”** → **avans neconfirmat** (av=0 ≠ „fără avans”).

**Formula de ajustare completă** (479 pag. 4–5, poz. ~13 300):
„An = av + m * Mn/Mo + f * Fn/Fo + e * En/Eo […] „An" este coeficientul de ajustare care urmează a fi aplicat valorii contractuale aferente lucrărilor realizate în luna „n"; […] m = 0,55; f = 0,25; e = 0,20; – „Fn", „En", „Mn" sunt indicii curenți de preț/cost sau prețurile de referință pentru luna „n", exprimați în moneda Contractului, după cum sunt aplicabili la data cu 60 de zile înainte de ultima zi a lunii „n"; M = materialele principale care intră în lucrările executate, F = manopera (forța de muncă), E = energia (carburanții pentru utilaje); – „Fo", „Eo", „Mo" sunt indicii de preț/cost de bază sau prețurile de referință, exprimați în moneda Contractului, aplicabili la Data de Referință. Indicii […] vor fi cei publicați în Buletinele statistice lunare și de prețuri ale Institutului Național de Statistică […] Se va verifica ecuația av + m + f + e = 1. În cazul în care un indice […] nu este disponibil ori valoarea acestuia nu este definitivă, se va utiliza ultimul indice sau preț disponibil, urmând ca ajustarea să fie recalculată”.
Eveniment: coeficientul se aplică lucrărilor realizate în luna „n”. 480 (poz. ~12 415) trimite sursa indicilor la „documentaţia de atribuire şi anexele Contractului”. **„Data de Referință” nu e definită** în 479/480 (singurele apariții sunt în formulă) → clarificare.

**Plafon penalități.** Executant: plafon **neidentificat în sursele verificate** (căutat „plafon”, „nu poate depasi” — singura apariție e la achizitor). Achizitor (480 poz. ~51 700): „o suma echivalenta cu 0,1% din plata neefectuata, pana la indeplinirea efectiva a obligatiilor. Cuantumul penalitatilor nu poate depasi valoarea debitului restant.” — **periodicitatea NU e scrisă** (lipsește „pe zi”, spre deosebire de executant: „0,1% pe zi” / „0,1% pentru fiecare zi de intarziere”) → clarificare.

**GBE / penalități** = scenarii calculate pe valoarea estimată (proxy), nu pe prețul ofertat.

**Valabilitatea garanției de participare** (479 poz. 75 563, citat exact): „Referitor la garanția de participare - Perioada de valabilitate a garanției de participare va fi cel puțin egală cu perioada de valabilitate a ofertei, respectiv 4 luni de la data limita de depunere a ofertei stabilită prin anunțul de participare publicat în SEAP.”

**Cont beneficiar.** 480 poz. ~791: „cod fiscal 3796837, cont trezorerie RO71TREZ2015006XXX000189” — date beneficiar/cont de verificat (CUI 3796837 în 480 și I.1 vs 379683 în III.1.6.a).

**Cei 3 bani.** 479 poz. 4296, text exact: „TOTAL EXECUȚIE | 29.067.716,7\n\nVALOAREA TOTALA ESTIMATA: 37.366.625,89.” Textul extras are o singură zecimală. 8.298.909,16 + 29.067.716,70 = 37.366.625,86 ≠ 37.366.625,89. Ipoteză: E2 = 29.067.716,73 trunchiat la extragere — **neconfirmat**; de verificat pe PDF (pag. 2 FD) sau în clarificări.

**Livrabile** (FD 479 „Documentele solicitate” 1–10 + formulare 481 + clarificări):
- Garanția de participare (370.000 lei, valabilă ≥4 luni de la depunere);
- DUAE (răspuns) pentru toți operatorii;
- Formularele 1, 2 (doar asociere), 3 (art. 59-60), 4, 41, 5, 6, 7, 8, 9, 10, 11 (doc 481);
- Documente terț susținător (anexe F4), dacă e cazul;
- Propunerea tehnică + Planul de management al calității;
- Propunerea financiară: Formular de ofertă (preț E1, preț E2, total), Lista de prețuri/Centralizator financiar, Graficul general fizic și valoric;
- Clarificări: întrebările §9 (termen 01.10.2026).

### Decizii umane
1. Avans: întrebăm în clarificări sau acceptăm av=0 ca fără avans?
2. Plafon penalități executant + periodicitatea penalității achizitorului → clarificare.
3. Data de Referință + indici INS concreți → clarificare.
4. GBE: pe total sau E1; SGB vs rețineri.
5. Garanția de participare: virament vs poliță; CUI/IBAN de verificat.
6. Valoarea E2 (3 bani) → verificare PDF/clarificare.
7. Go/no-go și repartizarea costurilor fixe pe E1.
