...
Runda 12 (26.09, verificatorul rundei 11: 2 majore, 3 minore): capătul **crescător fără prefix** al unui interval standard e Dn și urmat de alt cuvânt — „Total rețea De 63 - 110 PEHD”, „De 63-110 (PE)”, „De 63 ÷ 110 pozate subteran” sunt din nou TOTAL global (major, regresie a rundei 11: listă neagră de unități în locul listei albe, doar pe acest capăt); **fail-safe structural** în locul altor prefixe: un rând cu „total” nerecunoscut ca subtotal („A.1 Total …”, „Lot 1 - Total …”, „Tronson A: Total …”, „Lungime totală …”) lângă o poziție compatibilă ⇒ AMBIGUU vizibil (major TOTAL-a, rest); după „Cap./Art./Poz./Pct.” doar un token de numerotare, pozițiile de alt material scoase din candidați, descrescătorul fără prefix + „mm” = grosime, teste pe mutațiile supraviețuitoare (minore); `COD_VERSIUNE` 2026-09-26.16 (commit `1cc92bd`; §5.5–5.7).
...
Teste finale pe ramură (pe capul ramurii, după runda 12; toate cu `--node-modules-dir=none --no-lock`, `deno.lock` neatins, md5 `875e293d…`):

| Comandă | Rezultat |
|---|---|
| `deno test supabase/functions/ofertare-plansa-citeste` | **159/159** (după `91eb62e`: 152/152; după `85c53f1`: 147/147; după `3197aa3`: 141/141; după `b5e7ecd`: 132/132; după `e8489a6`: 122/122; după `f1c4b66`: 109/109; după `f1274a1`: 100/100; după `a9fe186`: 89/89; după `a800d38`: 78/78) |
| `deno test -A supabase/functions/` | **176/176** (după `91eb62e`: 169/169; după `85c53f1`: 164/164; după `3197aa3`: 158/158; după `b5e7ecd`: 149/149; după `e8489a6`: 139/139; după `f1c4b66`: 126/126; după `f1274a1`: 117/117; după `a9fe186`: 106/106; după `a800d38`: 95/95) |
| `concurenta_test.ts` rulat de 10 ori | 10/10 verzi, 88/88 de fiecare dată |
...
- **TOTAL-b, fals-pozitivul rundei 10** (MAJOR, regresie față de `7a7bf86`). Separatorii de listă / interval ai rundei 10 luau drept Dn orice număr standard fără prefix, dacă după el nu venea o unitate din lista scurtă: „Total conducte De 110, 20 tronsoane” ⇒ [20, 110]; „… De 110 și 32 branșamente” ⇒ [32, 110]; „Dn110 la 32 case”, „De 110 / 16 bar”, „De 110 la 20 bar”, „De 225/20”, „De 180/16” ⇒ interval. Subtotalul Dn110 devenea TOTAL global: primul în BD lua 1.100 (umflat, „extras”), iar TOTAL-ul real rămânea TĂCUT la 1.000 „VECHE 6”; cu TOTAL-ul real primul, subtotalul ieșea din rețea și din orice scriere, TĂCUT „VECHE 4” (ADV11-3 / 3r). Acum, în `RE_DN_DENUMIRE`:
  - numărul **fără prefix** (al doilea capăt sau element de listă) e Dn doar dacă după el vine sfârșitul, punctuație / separator (`) , ; . : / ÷ – — - + & …`), „mm”, alt separator de listă / interval („și”, „sau”, „la”, „până”) sau un material / SDR („pe”, „PE100”, „ol”, „sdr”), și nu zecimale. Orice alt cuvânt (tronsoane, branșamente, case, bar, metri, mp, poz …) îl anulează; *corectat în runda 12: pentru capătul CRESCĂTOR cu ambele capete standard lista albă respingea și „PEHD”, „(PE)”, „pozate”, „conducte” ⇒ „Total rețea De 63 - 110 PEHD” devenea subtotal Dn63 (regresie; acolo e acum listă neagră de unități, mai jos)*;
...
- „Lungime totală conducte PE De 110” lângă poziția fără material (minor, documentare): limită scrisă în §5.7. *Închisă în runda 12 (fail-safe structural): acum AMBIGUU, nimic scris.*

**Runda 12 — transferul** (verificatorul rundei 11: 2 majore, 3 minore; commit `1cc92bd`; `COD_VERSIUNE` 2026-09-26.16). Pe BD nu apare niciunul (SELECT 26.09, refăcut: 19 denumiri cu „total”, 0 care nu încep cu „total”, 0 cu Dn; nicio licitație cu poziții OL și altele pe același Dn ⇒ clasificarea și țintele de azi sunt neschimbate).
- **TOTAL-b, fals-negativul rundei 11** (MAJOR, regresie față de `7065789`; pentru „-” și „(PE)” și față de `7a7bf86`). Lista albă a rundei 11 (`URMARE_FARA_PREFIX`) respingea al doilea capăt al unui interval CRESCĂTOR standard urmat de un cuvânt din afara listei: „PEHD” / „HDPE” (nu trec de `pe(?:\d|\b)`), „(PE)”, „conducte”, „pozate”, „polietilenă”. „Total rețea De 63 - 110 PEHD”, „De 63-110 (PE)”, „Total conducte De 63 - 110 conducte PE”, „De 63 ÷ 110 pozate subteran” ⇒ [63], adică subtotal Dn63. E2E ADV12-1 (planșa Dn110 900 + Dn63 200, TOTAL memoriu 1.100 / cp 1.000): cu poziția Dn63, TOTAL-ul rămânea 1.000 cu nota „total cu Dn … neatribuit”; fără ea, TOTAL-ul (și validat) primea 200 m, „Memoriu 1.100 m vs 200 m (-900 m)”, iar Dn63 nu se insera. Acum (`dnuriDenumire`, grupurile 5–7 din `CAPAT_2`):
  - capătul **fără prefix** al unui interval **crescător**, cu **ambele** capete standard, se acceptă pe o **listă neagră**: e Dn, cu excepția zecimalelor și a unei unități / unui numărător după el (`NU_UNITATE`: m, ml, mc, mp, metri, metru, km, cm, %, buc, bucăți, tronson(oane), branșament(e), case, bar, atm, kg, ore, zile, luni, ani);
  - lista albă strictă rămâne pentru capătul **descrescător** și pentru **elementele de listă** — toate fals-pozitivele rundei 10 („, 20 tronsoane”, „la 32 case”, „/ 16 bar”, „- 50 branșamente”, „De 225/20”) rămân subtotal (testul unitar al rundei 11 neschimbat);
  - minorul (1): descrescătorul fără prefix urmat de „mm” e grosimea peretelui, nu interval („De 180 - 16 mm”, „De 225 - 20 mm” ⇒ subtotal); crescătorul cu „mm” („De 63 - 110 mm”) și descrescătorul cu prefix („Dn 110 - Dn 63 mm”) rămân interval.
  ADV12-1, 4 denumiri × extras / validat × (cu / fără poziția Dn63): TOTAL-ul „confirmă totalul: 1.100 m”; Dn63 = 200 pe poziția lui sau inserat („Conductă distribuție gaze PE Dn63”, `adaugate` 1).
- **TOTAL-a, fail-safe structural** (MAJOR, pre-existent: aceleași forme tăcute și pe `7065789` / `7a7bf86`). `eSubtotal` recunoaște doar forme enumerate; „A.1 Total …”, „A.1. Total …”, „Nr. 3 Total …”, „Capitolul 2 - Total …”, „Lot 1 - Total …”, „Obiect 2 Total …”, „Tronson A: Total …” (și „Totaluri …”, din cauza `\b` al rundei 11) nu erau subtotal: cu materialul grupului în denumire, filtrul pe material îi dădea cifra (500 „confirmă”), iar poziția reală „Conductă distribuție gaze Dn110” validată rămânea TĂCUT la 480 „VECHE 3” (ADV12-2). În loc de alte prefixe, în `candidatiPe`, după `preferaFaraTotal` (și după restrângerea la pozițiile compatibile, mai jos): dacă printre candidații rămași (≥ 2) e un rând cu „total” în denumire (`/total/`, oriunde) care **nu** e subtotal recunoscut, **filtrul pe material nu mai departajează** — setul e AMBIGUU (în `ambigue`, nimic scris), la fel pe „doar de verificat”. Astfel toate formele de mai sus (și „Lungime totală conducte PE De 110”, limita rundei 11) devin vizibile; ADV10-2 și garda „prim cuvânt” rămân ambigue ca înainte. „Totaluri conducte …” e din nou subtotal (`total` fără `\b`, ca pe `7065789`). Două subtotaluri **recunoscute** (PE și fără material), fără poziție reală: filtrul pe material departajează ca înainte (gardă).
- **`eSubtotal` pe ramura cu prefix** (minor, identic pe `7a7bf86`). `[\w.]*` după „Cap./Art./Poz./Pct.” înghițea un cuvânt: „Poz. conductă total PE Dn110”, „Art. racord total …”, „Cap. conductă total OL …” deveneau subtotal, iar lângă „Conductă OL Dn110”, cu grupul fără material, OL primea 500. Acum după prefix se acceptă doar un token de numerotare (`\d[\d.]*`, cifre romane sau o literă, cu „.” opțional) ⇒ ADV12-3 AMBIGUU, nimic scris. „C) total conductă PE Dn110” și „Ex. total PE Dn110” (ramura de 1–2 litere) rămân subtotal — limită în §5.7.
- **Compatibilitatea de material, restrângerea** (minor (3), vizibil înainte). Cu materialul grupului cunoscut și ≥ 2 candidați, pozițiile de **alt** material se scot din candidați când rămâne cel puțin una compatibilă (același material sau fără material). Grupul OL cu „Total conducte OL De 110” + „Conductă PE Dn110” + „Conductă distribuție gaze Dn110”: înainte AMBIGUU între PE (incompatibil) și poziția fără material; acum OL 40 pe poziția fără material, subtotalul OL notă, PE neatins. La fel grupul PE cu „Total conducte PE De 110” + „Conductă OL Dn110” + poziția fără material (ADV12-4); mutația `some → every` din `preferaFaraTotal` (subtotalul ar lua cifra, poziția validată TĂCUT) e prinsă aici.
...
- **Runda 12 — verificatorul rundei 11** (`agregare_test.ts` +1, `concurenta_test.ts` +6; un test existent schimbat intenționat: aserțiunea limitei „Lungime totală … PE” din ADV11-1 — acum AMBIGUU, nimic scris). Probele ADV12-1…4 ale verificatorului sunt teste cu aserțiuni, în ambele ordini. Suitele: `ofertare-plansa-citeste` **159/159**, `-A supabase/functions/` **176/176**, `concurenta_test.ts` 10 × 88/88, `test-cas-felii` 34/34, `test-detector-sigla` 30/30, `verifica-poarta-identica` OK, `deno check index.ts` exit 0 (runda 12 nu atinge `api/`); `deno.lock` neschimbat (md5 875e293d).

  | Test (runda 12) | Rezultat acum | Pe `4c50dd2` | Pe `7065789` |
  |---|---|---|---|
  | `dnuriDenumire` (unitar): 7 intervale crescătoare urmate de alt cuvânt („PEHD”, „(PE)”, „pozate”, „conducte PE”, „HDPE”, „polietilenă”, „inclusiv”); 11 forme pe lista neagră (bar, buc, %, tronsoane, m, metri, branșamente, ml, km, case, zecimale); primul capăt nestandard; descrescător + cuvânt / + „ol”; „- 16 mm” / „- 20 mm”; „&”, „÷”, „până”, „pentru” în liste | trece | pică | pică („mm”, lista albă) |
  | **ADV12-1** (E2E): 4 denumiri × extras / validat × cu / fără poziția Dn63 | TOTAL 1.100 „confirmă”, Dn63 200 (poziție / inserat) | TOTAL 1.000 „neatribuit” / 200 „-900 m”, Dn63 neinserat | trece |
  | **ADV12-2** (E2E): 8 forme nerecunoscute × 2 ordini ⇒ ambiguu [3, 4], nimic scris; „III.”, „VIII)”, „aa)”, „Pct. 4”, „Poz. 12”, „Totaluri” ⇒ poziția 500, subtotalul notă | ca în stânga | subtotalul 500, poziția TĂCUT 480 | idem |
  | ADV12-2, calea „doar de verificat” („A.1 Total conducte PE De 90”) | ambiguu, nimic scris | subtotalul golit, poziția TĂCUT 280 | idem |
  | **ADV12-3** (E2E): „Poz. / Art. / Cap. <cuvânt> total …” + „Conductă OL Dn110” × 2 ordini | ambiguu, nimic scris | OL 500 „confirmă” | trece |
  | **ADV12-4** (E2E): grup PE și grup OL, subtotal + alt material + fără material × 2 ordini | cifra pe poziția fără material, subtotalul notă, celălalt material neatins | ambiguu (vizibil) | ambiguu |
  | Gardă: două subtotaluri recunoscute (PE, fără material), fără poziție reală | subtotalul PE ia cifra | trece | trece |

  **Control negativ** (`scratchpad/r12w/neg_4c50dd2`, `neg_7065789`, `neg_7a7bf86`: handler-ul vechi, testele noi): pe `4c50dd2` 145 de teste, **7 pică** — cele 6 noi care vizează defectele și limita actualizată din ADV11-1 —, garda trece; pe `7065789` pică 8 (4 ale rundei 11 + 4 ale rundei 12: unitarul, ADV12-2, ADV12-2 pe „doar de verificat”, ADV12-4), iar ADV12-1 și ADV12-3 trec — confirmă că erau regresii ale rundei 11; pe `7a7bf86` pică 15.

  **Mutații pe o copie a handler-ului nou** (`scratchpad/r12w/mut.py`; copia nemutată 145/145): **52/52 prinse** — lista neagră: ramura scoasă, fără unități, fără zecimale, fără %, m, metri, bar, buc, tronsoane, case, km, ml, branșamente (câte 1–3 teste); lista neagră fără „primul capăt standard” 1, permisă la descrescător 1; „mm” descrescător permis 1, ramura „mm” scoasă 1; lista albă: fără „ol”, „până”, „÷”, „&”, `pe(?:\d|\b)` → `pe` (cele 5 supraviețuitoare ale verificatorului, acum câte 1), oarecare 4; „/” descrescător fără prefix 1, crescător fără standard 2, `b >= a` 1; `eSubtotal`: token = cuvânt 1, `total\b` 1, fără cifre romane 1 (izolat: „III.”, „VIII)”), litere doar 1 („aa)”), fără „pct” / „poz” / „cap” / „art” câte 1, fără litere 2, fără „subtotal” 3, „total” oriunde 7; fail-safe: scos 3, doar `\btotal\b` 2, și pe subtotaluri recunoscute 1 (garda); compatibilitate: restrângerea scoasă 1, `some → every` 2, fără „poziție fără material” 8, `preferaFaraTotal` fără compatibilitate 1; materialul înaintea priorității 9, materialul ignorat în ținte 7; regulile rundelor 9–10: `esteTotal` fără ≥ 2 Dn 1, fără „÷” 4, fără „la” 4, fără liste 4, `NU_ZECIMALE` gol 2, bucla „total cu Dn” fără excluderea seturilor ambigue 7. Mutația verificatorului „`NU_ZECIMALE` pe elementul de listă cu prefix” e **echivalentă**: primul număr al fiecărei potriviri n-are gardă de zecimale, deci „De 110,5” e citit oricum ca Dn110 de potrivirea următoare (pre-existent).

  **Probele verificatorului pe handler-ul nou** (`scratchpad/r12w/p`): ADV12-1 toate „confirmă totalul: 1.100 m” și Dn63 200 / inserat; ADV12-2: formele recunoscute „OK”, celelalte 16 cazuri AMBIGUE [3, 4] (niciunul 480 fără notă); ADV12-3: cele 3 cu prefix ambigue, „C)” / „Ex.” rămân subtotal (limită); ADV12-4 ca în tabel. `probe_unit`: toate cele 4 denumiri ale majorului = { dn: [63, 110], interval: true }; față de `7065789` diferă doar „De 110, 20, 25 tronsoane” ([20, 110]), „De 180 / 225 - 16 / 20 mm” (acum subtotal), „la 90 cm”, „si 32 (bransamente)”, „/ 20 PE”, „Dn 110/63” (runda 11) și „De 110 - Dn 20 m” (interval, ca pe `7a7bf86`). `p130` = 18 / 37.320 m (Dn250 30.970, Dn180 1.105, Dn160 5.245); 470 = 133 / 48.905 m.

### 5.7 Limite cunoscute (documentate, nu blochează) — actualizat în runda 12
...
**Ce a mai devenit vizibil în runda 11:** subtotalul Dn urmat de un număr care nu e Dn („, 20 tronsoane”, „/ 16 bar”, „De 225/20”) rămâne subtotal, iar TOTAL-ul real primește totalul; subtotalul numerotat cu litere / cifre romane / „Cap. 3” lângă poziția reală primește nota, iar poziția cifra. *Corectură runda 12: lista albă a rundei 11 făcea din „Total rețea De 63 - 110 PEHD” / „(PE)” / „pozate” un subtotal Dn63 (TOTAL-ul cu 200 m sau „neatribuit”, Dn63 neinserat); formele „A.1 Total”, „Lot 1 - Total” luau încă tăcut cifra.*

**Ce a mai devenit vizibil în runda 12:** intervalul crescător standard urmat de alt cuvânt e din nou TOTAL; orice rând cu „total” nerecunoscut ca subtotal, lângă o poziție compatibilă, face setul AMBIGUU (nu mai ia tăcut cifra, inclusiv „Lungime totală conducte PE De 110”); „Poz. <cuvânt> total …” nu mai e subtotal; grupul cu material merge pe poziția fără material când singura altă poziție e de alt material.
...
- **La transfer:**
  ...
  - rândul TOTAL = „total” în denumire cu **niciun Dn standard, ≥ 2 Dn-uri sau un interval** (runda 9; runda 8 lua doar „fără Dn”, iar „Total rețea De 63–110” devenea candidat Dn63 și primea subtotalul în rândul TOTAL validat, cu poziția Dn63 dispărută); un „total” cu **un singur** Dn e candidat pe Dn-ul lui. Un **subtotal** (denumire care începe cu „total” / „subtotal” ca prim cuvânt, după semne, după o numerotare cu cifre, 1–2 litere sau cifre romane, ori după „Cap.” / „Art.” / „Poz.” / „Pct.” urmate doar de un token de numerotare; runda 10, completat în rundele 11–12) e candidat doar când e singurul de pe Dn: lângă o poziție fără „total” pe același Dn, **compatibilă cu materialul grupului** (același material sau fără material; grupul fără material = oricare), primește doar notă (runda 10: prioritatea se aplică înaintea filtrului pe material, în ținte și la „doar de verificat”; runda 11: doar în favoarea pozițiilor compatibile — „Total conducte OL De 110” lângă „Conductă PE Dn110”, cu grupul OL, ia cifra OL). O poziție care conține „total” în altă parte („… lungime totală”) e poziție reală (runda 10), dar, din runda 12, un astfel de rând (sau orice „total” nerecunoscut ca subtotal: „A.1 Total …”, „Lot 1 - Total …”) lângă altă poziție compatibilă face setul AMBIGUU — filtrul pe material nu mai departajează (fail-safe). Tot din runda 12, cu materialul grupului cunoscut, pozițiile de alt material ies din candidați când rămâne una compatibilă. Rămân:
    ...
    - un subtotal care **nu** începe cu „total” și nu e recunoscut („Lungime totală conducte De 110”, „Conducte De 110 — total”, „A.1 Total …”, „Lot 1 - Total …”, „Tronson A: Total …”) e tratat ca poziție reală: lângă altă poziție compatibilă pe același Dn iese AMBIGUU (vizibil, `ambigue`, nimic scris), nu notă — din runda 12 și când materialul grupului e în denumirea lui (înainte: „Lungime totală conducte PE De 110” lua cifra, iar poziția fără material rămânea tăcut; închis). Costul fail-safe-ului: un subtotal real nerecunoscut blochează scrierea pe Dn-ul lui până la verificarea omului (vizibil). Rămân subtotal (enumerare): „C) total conductă PE Dn110”, „Ex. total PE Dn110” (ramura de 1–2 litere urmate de „.” / „)”) — lângă o poziție compatibilă, poziția primește cifra, iar rândul nota „total cu Dn” (vizibil; denumiri puțin realiste);
    - intervalul se recunoaște pe „-”, „–”, „—”, „÷”, „/”, „…” / „...”, „la”, „până la” după un număr cu prefix Dn/De/Ø, iar lista pe „,”, „;”, „+”, „&”, „și”, „sau” (runda 10). Al doilea capăt / elementul din listă **fără prefix** e Dn doar urmat de sfârșit, punctuație / separator, „mm”, alt separator de listă / interval sau material / SDR, și nu de zecimale (runda 11); cu prefix, e Dn oricum, fără zecimale. Din runda 12, capătul **crescător** fără prefix, cu ambele capete standard, e Dn și urmat de alt cuvânt („De 63 - 110 PEHD”, „(PE)”, „pozate”), cu excepția zecimalelor și a unei unități / unui numărător (listă neagră); consecința: „De 110 - 160 <cuvânt oarecare în afara listei>” e interval (TOTAL global) — fals-pozitiv posibil dacă un subtotal Dn110 e urmat de un număr standard mai mare și de un cuvânt neprevăzut; descrescătorul fără prefix urmat de „mm” e grosime, nu interval („De 180 - 16 mm”; „Dn 110 - 63 mm” devine astfel subtotal Dn110, fals-negativ vizibil). Rămân interval (pre-existent): „De 110 - 16” la sfârșit (grosimea fără „mm”) și „De 110 - Dn 20 m” (descrescător cu prefix); „De 110, 20, 25 tronsoane” și „De 110, 20.” dau [20, 110] (elementul urmat de „,” / „.”) — forme artificiale. „De 63 - 110 ml” / „… m” ⇒ subtotal Dn63 (lista neagră; fals-negativ vizibil). Nu se recunosc: numere fără niciun prefix („Total 63÷110” — dar fără Dn e oricum TOTAL), numere separate doar prin spațiu („Dn 63 90 110” ⇒ subtotal Dn63), un element fără prefix urmat de alt cuvânt, chiar dacă e o listă reală („Dn 63 și 110 m”, „Dn 63 și 110 (PE)” ⇒ subtotal Dn63: fals-negativ — rândul e tratat ca subtotal Dn63, deci primește nota „total cu Dn” lângă poziția reală Dn63 sau, singur pe Dn63, cifra Dn63 cu diferența față de memoriu în notă; vizibil, nu tăcut), un interval crescător fără prefix cu al doilea capăt nestandard („De 110 - 120”), un interval descrescător cu un capăt nestandard. Pe „/” (grosimea peretelui: „De 110/10”, „De 225/20”, „De 110/100”) descrescătorul fără prefix nu e interval (runda 11; în runda 10 „De 225/20” și „De 110/100” erau). Pe BD nu există nicio denumire „total” cu Dn, interval sau listă de Dn (SELECT 26.09, refăcut în runda 11: 19 denumiri „total”, toate încep cu „total” fără numerotare, 0 cu Dn);
