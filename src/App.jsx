...
.toast{position:fixed;top:76px;right:18px;padding:10px 16px;border-radius:10px;font-size:13px;font-weight:600;z-index:9999;box-shadow:0 8px 32px rgba(0,0,0,.5);animation:fi .3s ease;max-width:min(420px,calc(100vw - 36px))}
`
  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/aplica" element={<AplicaPublic/>}/>
