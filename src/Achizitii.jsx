  ...
  return (
    <div style={{ ...S.page, padding:'24px 0' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:18, flexWrap:'wrap' }}>
        ...
        {canCreate && (tab === 'comenzi' || tab === 'arhiva') && (
      ...
      {proiecteChips.length > 0 && (tab === 'comenzi' || tab === 'arhiva') && (
      ...
      <div style={{ display:'flex', gap:8, marginBottom:14, borderBottom:`1px solid ${G.border}`, paddingBottom:0 }}>
        {[['comenzi', '🛒 Comenzi active'], ['arhiva', `📁 Arhivă${arhivaCount ? ` (${arhivaCount})` : ''}`], ['cereri', '📋 Cereri interne'], ...(isOwner ? [['aprobatori', '👥 Aprobatori']] : [])].map(([k, t]) => (
      ...
      {tab === 'cereri' && <CereriInterneProiect inbox />}
