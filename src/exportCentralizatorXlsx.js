...
const SHEET1_COL_WIDTHS = [
  ...
  { wch: 6.6 },    // F: ȘARJA (~57 px; xlsx-js-style adaugă +0.83 → 7.43 rendered)
  { wch: 8.71 },   // G: CANT.
  { wch: 7.71 },   // H: TRONSON
  { wch: 15.86 },  // I: POZ. KM
  { wch: 10.71 },  // J: SUDURĂ
