...
import { PROMPT_INVENTAR, PROMPT_COMPARA } from './prompturi.ts'
...
Deno.serve(async (req: Request) => {
  ...
  if (actiune === 'compara') {
    ...
    const prompt = PROMPT_COMPARA
      ...
      + `\nO operatie = un singur id de cerinta. Cele ${lot.length} dispozitii trebuie sa iasa toate: ori ca operatie, ori in "neclare".`
