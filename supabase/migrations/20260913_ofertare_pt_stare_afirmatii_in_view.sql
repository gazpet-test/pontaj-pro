-- P0.1 (audit 13.09.2026): UN SINGUR ADEVAR pentru verdictul portii.
-- Conditia de blocaj era copiata in 3 locuri din OfertarePropunere.jsx, iar copia din
-- PropunereRezumat (cardul din fisa licitatiei) NU continea capitole_goale si
-- capitole_nescrise_de_om — deci cardul putea spune "Poarta e deschisa" cand panoul bloca.
-- Randul de conformitate (afirmatiile propunerii) era singurul care nu venea din view, ci din
-- v_ofertare_pt_conformitate incarcata separat de panou; cardul n-o incarca deloc. Le aducem
-- aici, ca evaluatorul JS (src/ofertarePoarta.js) sa citeasca TOTUL dintr-un singur rand.
