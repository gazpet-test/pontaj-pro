-- P0.3: randul de poarta "cerinte atribuite dar neverificate". O legatura fel='capitol' cu
-- stare <> 'verificata' inseamna ca nimeni n-a confirmat ca raspunsul satisface cerinta.
-- Se numara si cele verificate la o versiune VECHE a capitolului (P0.6, baza): textul s-a
-- schimbat de la verificare, deci verificarea nu mai e a textului curent.
