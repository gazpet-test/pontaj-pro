-- v5 (25.09.2026): o ciornă editată/aprobată de om NU mai e retrogradată la 'propunere' când apar planșe noi (se actualizează doar sursa).
...
--     cantitative în lectura efectuată” (NU „documentul nu conține”); DWG/PDF-text cerut doar pt ilizibile.
--  3) regula v3 păstrată: textul editat de om NU se suprascrie (doar sursa/statusul).
--  4) plansa.rezultat e sursa principală; eroare/citibila = fallback pt docuri istorice.
