-- Constatare din cercetarea Codex (13.09.2026), P0: randul de grafic din poarta propunerii era
-- 'ok' doar fiindca EXISTA o versiune inghetata — fara sa se uite la verdictul acelei versiuni.
-- O versiune salvata nu e un grafic verificat. Generarea e blocata cand poarta graficului are
-- randuri rosii (GraficPoarta.jsx:277), deci un 'block' nu poate ajunge in grafic_versiuni;
-- AVERTISMENTELE insa da — si alea erau ascunse complet sub un bifat verde in poarta propunerii.
