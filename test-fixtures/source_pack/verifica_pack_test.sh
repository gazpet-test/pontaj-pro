...
ok(L["REQ-003"].verificat==="pagina","REQ-003 pagina 4 în intervalul ⟦PAGINA 3-5⟧")
ok(L["REQ-004"].verificat==="document" && L["REQ-004"].pagina===3 && JSON.stringify(L["REQ-004"].pagina_interval)==="[3,5]","REQ-004 corectat în interval 3-5")
